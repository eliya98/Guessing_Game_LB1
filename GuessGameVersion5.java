...
Purpose: create game for user to guess a random number between 1 and 100
Resources: "CS141 Lab 4: Guessing game" */

import java.util.Random;
import java.util.Scanner;

public class GuessGameVersion5 {
    ...
    public static void main(String[] args) {
        ...
        while (playAgain) {
            ...
            while (true) {
                ...
                int guess = getGuess(console); // get first guess
                int numGuesses = 1;
    
                while (guess != number) {// give hints until correct guess is reached
    ...
    public static void displayHint(int numMatches, int number, int guess ) {
        ...
        System.out.println("|                                       (hint: " + numMatches +
                                                                             " digits match)|");
        System.out.println("|_____________________________________________________________|");
    }
